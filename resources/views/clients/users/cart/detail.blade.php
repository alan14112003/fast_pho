        ...
        <button class="order-summary-toggle order-summary-toggle-hide">
            <div class="wrap">
                <div class="order-summary-toggle-inner">
                    ...
                    <div class="order-summary-toggle-total-recap" data-checkout-payment-due-target="40000000">
                        <span class="total-recap-final-price">400,000₫</span>
                    </div>
                </div>
            </div>
        </button>
                                        ...
                                        <div class="field field-show-floating-label">
                                            <div class="field-input-wrapper">
                                                ...
                                                <input placeholder="Họ và tên" autocapitalize="off" spellcheck="false"
                                                    ...
                                                    @auth value="{{ auth()->user()->name }}" @endauth autocomplete="false"
                                                    required>
                                            </div>
                                        </div>
