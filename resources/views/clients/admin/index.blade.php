                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h3 class="h4 mb-3">New messages</h3><a
                                        ...
                                        href="#">
                                        <div class="position-relative"><img class="avatar" src="img/avatar-3.jpg"
                                        ...
                                        class="d-block d-flex align-items-center text-reset text-decoration-none bg-dash-dark-2 py-2 px-3"
                                        href="#">
                                        <div class="position-relative"><img class="avatar" src="img/avatar-2.jpg"
                                        ...
                                        class="d-block d-flex align-items-center text-reset text-decoration-none bg-dash-dark-2 py-2 px-3"
                                        href="#">
                                        <div class="position-relative"><img class="avatar" src="img/avatar-1.jpg"
                                        ...
                                        class="d-block d-flex align-items-center text-reset text-decoration-none bg-dash-dark-2 py-2 px-3"
                                        href="#">
                                        <div class="position-relative"><img class="avatar" src="img/avatar-5.jpg"
                                                alt=""><span class="availability-status bg-gray"></span></div>
                                        <div class="ms-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="position-relative text-center">
                                        ...
                                        <div class="position-absolute top-50 start-50 translate-middle"><strong
                                                class="text-lg d-block">$2.145</strong><span class="d-block">Sales</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="position-relative text-center">
                                        ...
                                        <div class="position-absolute top-50 start-50 translate-middle"><strong
                                                class="text-lg d-block">$7.784</strong><span class="d-block">Sales</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="position-relative text-center">
                                        ...
                                        <div class="position-absolute top-50 start-50 translate-middle"><strong
                                                class="text-lg d-block">$4.957</strong><span class="d-block">Sales</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
